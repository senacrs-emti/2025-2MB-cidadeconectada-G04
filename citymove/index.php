...
<head>
  ...
  <link rel="icon" href="c:\Users\leona\Downloads\CityMove\imagens\favicon.png">
</head>
<body>
  ...
  <footer class="site-footer">CityMove • Projeto de demonstração • Substitua <code>YOUR_API_KEY</code> pela sua chave do Google Maps</footer>

  <script src="script.js"></script>

  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCZU4Gq5cEDB5aZ6mTmE1rKYe9rVuvk470&libraries=places&callback=initMap"></script>
</body>
</html>
